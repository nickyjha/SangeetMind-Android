...
private val TERMS: Map<String, Int> = terms(
    ...
    // Chart yoga names
    "Ruchaka Yoga (Mars)" to R.string.astro_yoga_ruchaka,
    "Bhadra Yoga (Mercury)" to R.string.astro_yoga_bhadra,
    "Hamsa Yoga (Jupiter)" to R.string.astro_yoga_hamsa,
    "Malavya Yoga (Venus)" to R.string.astro_yoga_malavya,
    "Sasa Yoga (Saturn)" to R.string.astro_yoga_sasa,
    "Gajakesari Yoga" to R.string.astro_yoga_gajakesari,
    "Dhana Yoga (Basic Wealth)" to R.string.astro_yoga_dhana_basic,
    "Saraswati Yoga" to R.string.astro_yoga_saraswati,
    "Chandra Mangala Yoga" to R.string.astro_yoga_chandra_mangala,
    "Adhi Yoga" to R.string.astro_yoga_adhi,
    "Vasumati Yoga" to R.string.astro_yoga_vasumati,
    "Trilochana Yoga" to R.string.astro_yoga_trilochana,
    "Parvata Yoga" to R.string.astro_yoga_parvata,
    "Budhaditya Yoga" to R.string.astro_yoga_budhaditya,
    "Guru Mangala Yoga" to R.string.astro_yoga_guru_mangala,
    "Shubha Kartari Yoga" to R.string.astro_yoga_shubha_kartari,
    "Lakshmi Yoga" to R.string.astro_yoga_lakshmi,
    "Dharma Karmadhipati Yoga" to R.string.astro_yoga_dharma_karmadhipati,
    "Kendradhipati Raja Yoga" to R.string.astro_yoga_kendradhipati_raja,
    "Amala Yoga" to R.string.astro_yoga_amala,
    "Neecha Bhanga Raja Yoga (Enhanced)" to R.string.astro_yoga_neecha_bhanga_raja_enhanced,
    "Mridanga Yoga" to R.string.astro_yoga_mridanga,
    "Sannyasa Yoga" to R.string.astro_yoga_sannyasa,
    "Parivrajya Yoga" to R.string.astro_yoga_parivrajya,
    "Mahapataka Yoga" to R.string.astro_yoga_mahapataka,
    "Moksha Yoga" to R.string.astro_yoga_moksha,
    "Viparita Raja Yoga - Harsha" to R.string.astro_yoga_viparita_raja_harsha,
    "Viparita Raja Yoga - Sarala" to R.string.astro_yoga_viparita_raja_sarala,
    "Viparita Raja Yoga - Vimala" to R.string.astro_yoga_viparita_raja_vimala,
    "Pasa Yoga" to R.string.astro_yoga_pasa,
    // Mantra names
    "Gayatri Mantra" to R.string.astro_mantra_gayatri,
    "Jupiter Gayatri" to R.string.astro_mantra_jupiter_gayatri,
    "Mangal Gayatri" to R.string.astro_mantra_mangal_gayatri,
    "Shani Gayatri" to R.string.astro_mantra_shani_gayatri,
    "Shukra Gayatri" to R.string.astro_mantra_shukra_gayatri,
    "Chandra Gayatri" to R.string.astro_mantra_chandra_gayatri,
    "Surya Gayatri" to R.string.astro_mantra_surya_gayatri,
    "Budh Gayatri" to R.string.astro_mantra_budh_gayatri,
    "Rahu Gayatri" to R.string.astro_mantra_rahu_gayatri,
    "Ketu Gayatri" to R.string.astro_mantra_ketu_gayatri,
